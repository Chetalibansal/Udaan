...
export const AuthPage = () => {
  ...
  const handleLogin = (e) => {
    ...
    const role = loginData.email.includes("teacher")
      ? "teacher"
      : loginData.email.includes("parent")
      ? "parent"
      : "student";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-muted/30 animate-fade-in">
      <div className="w-full max-w-md mx-auto">
        ...
        {/* Auth Card */}
        <Card className="dashboard-card shadow-xl">
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup}>
                <CardHeader>
                  ...
                  <CardDescription className="text-center">
                    Join UDAAN to track student performance
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
